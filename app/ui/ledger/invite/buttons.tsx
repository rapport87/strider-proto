...
export function AgreeInviteButton({ledger_id}: {ledger_id : number}) {
  ...
  export function RefuseInviteButton({ledger_id}: {ledger_id : number}) {
  ...
  export function IgnoreInviteButton({ledger_id}: {ledger_id : number}) {
